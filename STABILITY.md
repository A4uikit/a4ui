...
| Recently-added standalone components                     | `Sortable`, `Clock`, `CalendarHeatmap`, `Comment`, `ColorPicker`, `Tour`, `Command`, `NotificationCenter`, `Cascader`, `TreeSelect`, `Mentions`, `SpeedDial`, `BottomNavigation`, `Marquee`, `DataGrid`, `Section`, `PricingTable`, `BeforeAfter`, `ActionBar`                             |
