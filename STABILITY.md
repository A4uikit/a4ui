...
| **`@a4ui/core/commerce`** subpath                        | `ProductCard`, `ProductGrid`, `PriceTag`, `QuantityStepper`, `CartLine`, `CartSummary`, `FilterGroup`, `PriceBlock`, `FacetSidebar`, `ConditionScale`, `createCart`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| Recently-added standalone components                     | `Sortable`, `Clock`, `CalendarHeatmap`, `Comment`, `ColorPicker`, `Tour`, `Command`, `NotificationCenter`, `Cascader`, `TreeSelect`, `Mentions`, `SpeedDial`, `BottomNavigation`, `Marquee`, `DataGrid`, `Section`, `PricingTable`, `BeforeAfter`, `ActionBar`, `Configurator`, `Aurora`, `SpecSheet`, `RatingsSummary`, `LogoWall`, `AnnouncementBar`, `ChatThread`, `Message`, `StreamingText`, `Citation`, `PromptComposer`, `ArtifactPanel`, `FloatingToolbar`, `PageTransition`, `InlineSelect`, `startViewTransition`, `createOptimistic`, `CodeTabs`, `PillSearch`, `CategoryStrip`, `MasterDetail`, `EASE`, `SPRING`, `SlashMenu`, `DataView`, `createLinkedSelection`, `.glass-refractive`, `.elevation-*`, `ScrollScene`, `StickyReveal`, `BalanceCard`, `TransactionFeed`, `KpiBlock`, `MoneyActionButton`, `Spaces`, `SideRail`, `BlockEditor` |
