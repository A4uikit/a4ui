...
| Group                                                   | Examples                                                                                                                                                                                                                              |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Motion components** (newest category, added `0.13.0`) | `ScrambleText`, `TextReveal`, `HoldToConfirm`, `LoadingDots`, `FillText`, `Curtain`, `Parallax`, `NotificationStack`, `MultiStateBadge`, `NowPlaying`, `Expandable`, the `flyToCart` helper                                           |
...
| **`@a4ui/core/commerce`** subpath                       | `ProductCard`, `ProductGrid`, `PriceTag`, `QuantityStepper`, `CartLine`, `CartSummary`, `FilterGroup`                                                                                                                                 |
...
| Recently-added standalone components                    | `Sortable`, `Clock`, `CalendarHeatmap`, `Comment`, `ColorPicker`, `Tour`, `Command`, `NotificationCenter`, `Cascader`, `TreeSelect`, `Mentions`, `SpeedDial`, `BottomNavigation`, `Marquee`, `DataGrid`                               |
